<div class="conditions">
        ...
        <h1 class="h-conditions">CONDITIONS DE VENTE (EUROPE DE L’OUEST, EUROPE CENTRALE, EUROPE DE L’EST)</h1>
         ...
         <div class="bloc-text">
            ...
            <p>
                ...
                VEUILLEZ LIRE ATTENTIVEMENT CES CONDITIONS DE VENTE AVANT DE COMMANDER DES PRODUITS EN LIGNE À PARTIR DE LA PLATEFORME Limitless Evolution. 
            ...
            <p>
                ...
                Vous lisez les présentes conditions de vente (« Conditions de Vente ») parce que vous utilisez un site internet, une expérience numérique, une plateforme de medias sociaux, une application mobile, une technologie portable Limitless Evolution ou un de nos autres produits ou services, lesquels font partis de la plateforme Limitless Evolution (« Plateforme »). Ces Conditions de Vente créent un accord juridiquement contraignant entre vous et Limitless Evolution et ses filiales (que nous désignons sous les termes « Limitless Evolution », « nous », « notre » ou « nos ») concernant les commandes passées pour des produits disponibles sur la Plateforme. Veuillez consulter notre Liste des Entités Locales pour obtenir le nom de l'entité Limitless Evolution en charge de vous fournir la Plateforme et les informations de contact appropriées. Limitless Evolution peut modifier ces Conditions de Vente sans notification préalable en publiant des Conditions de Vente modifiées sur sa Plateforme. Les Conditions de Vente affichées sur la Plateforme au moment de votre commande sur ladite Plateforme régiront cet achat. Veuillez lire attentivement ces conditions et vérifiez que les détails de votre commande sont complets et exacts avant de confirmer votre commande. Votre utilisation de la plateforme est également régie par les Conditions d'Utilisation et la Politique de Confidentialité de Limitless Evolution. Les Conditions d'Utilisation sont incorporées ici par ce lien. [Voir les conditions de la Hongrie.]. 

                PASSER DES COMMANDES SUR LA PLATEFORME 

                ELIGIBILITÉ POUR COMMANDER

                Pour passer une commande sur la Plateforme, vous devez être âgé d’au moins 16 ans, ou plus si la loi applicable l'exige pour conclure un accord avec Limitless Evolution et un consommateur - et non un revendeur. 

                AUCUN ACHAT POUR LA REVENTE
            </p>
            <p>
  La Plateforme est uniquement destinée a Limitless Evolution pour la vente directe des produits Limitless Evolution aux consommateurs finaux. L'achat de produits destinés à la revente est donc strictement interdit. L'achat pour la revente consiste en l'achat du produit Limitless Evolution par une personne qui revend ou a l'intention de le revendre à des tiers (consommateurs, entreprises ou toute autre tierce partie). Si Limitless Evolution pense que vous êtes impliqué dans l'achat pour la revente, Limitless Evolution se réserve le droit de prendre toute mesure à votre encontre, y compris, de façon non restrictive, de limiter les ventes à votre égard, d’annuler vos commandes et / ou de suspendre ou fermer votre compte. 
                ...
                vous avez moins de 16 ans ou avez un âge inférieur à celui requis par la loi applicable pour conclure un accord avec Limitless Evolution ;
            ...
            <p>
                ...
                Dans la mesure du possible, nous essayons de livrer tous les articles que vous avez commandés en même temps. Cependant, veuillez noter qu’en raison de la fabrication des produits personnalisés (Limitless EvolutioniD) dans différentes usines, une commande pour plusieurs produits personnalisés (Limitless EvolutioniD) peut entrainer des livraisons séparées. 
                ...
                Veuillez noter que vous êtes seul responsable de votre conception et de votre personnalisation, et que le droit de Limitless Evolution de refuser votre conception ou personnalisation ne saurait en aucun cas atténuer cette responsabilité. Le droit de Limitless Evolution de refuser votre conception ou personnalisation ne saurait en aucun cas être interprété comme une obligation de contrôler votre conception ou personnalisation. 
            ...
            <p>
                ...
                Les commandes personnalisées (Limitless EvolutioniD) ne peuvent pas être annulées avant l'expédition, car nous commençons la fabrication des produits personnalisés (Limitless EvolutioniD) immédiatement après réception de la commande. 
            ...
            <p>
                ...
                Vous acceptez que la Plateforme, les Conditions de Vente et tout litige entre vous et Limitless Evolution soient régis à tous égards par la loi néerlandaise, sans égard aux dispositions de la loi applicable, et non par la Convention des Nations Unies de 1980 sur les contrats de vente internationale de marchandises. 

                Sauf interdiction et sans limitation des droits des consommateurs, vous acceptez que tous les litiges, réclamations et procédures judiciaires découlant directement ou indirectement de la Plateforme (y compris, mais sans s'y limiter, l'achat des produits Limitless Evolution) soient résolus individuellement, sans recourir à aucune forme de recours collectif, et exclusivement devant les tribunaux compétents d'Amsterdam, aux Pays-Bas. 
                ...
                « Les présentes Conditions de Vente constituent un accord implicite entre vous et Limitless Evolution, à moins qu'il ne soit autrement satisfait aux exigences des accords écrits en vertu de la loi hongroise. » 
            ...
            <p>
                ...
                « Sauf autorisation et sans limitation à l'un de vos droits, vous acceptez que tous les litiges, réclamations et procédures judiciaires découlant directement ou indirectement de la Plateforme (y compris, mais sans s'y limiter, l'achat de produits Limitless Evolution) soient résolus individuellement, sans recourir à aucune forme de recours collectif, et exclusivement devant les tribunaux du lieu où vous résidez ou êtes domicilié. »
                ...
                Vous acceptez que la Plateforme, les Conditions de Vente et tout litige entre vous et Limitless Evolution soient régis à tous égards par la loi polonaise. 

                Sauf interdiction et sans limitation des droits reconnus aux consommateurs, vous acceptez que tous les litiges, réclamations et procédures judiciaires découlant directement ou indirectement de la Plateforme (y compris, mais sans s'y limiter, l'achat des produits Limitless Evolution) soient résolus individuellement, sans recourir à aucune forme de recours collectif, et exclusivement devant les tribunaux compétents en vertu de la loi applicable. 

                Dans le cas où vous avez une plainte ou estimez qu'il y a un différend entre vous et Limitless Evolution, veuillez nous contactez via [contact us page] d'abord. Dans le cas où le différend entre vous et Limitless Evolution n'est pas résolu, vous pouvez – sans y être obligé – utiliser la plate-forme de résolution en ligne des litiges accessible via http://ec.europa.eu/odr. »

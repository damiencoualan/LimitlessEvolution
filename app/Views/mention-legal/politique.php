<div class="conditions">
    ...
    <div class="back">
        <a href="index.php"><img src="../public/photo/logo/modal/close.svg" alt=""></a>
    </div>

    <h1 class="h-conditions">POLITIQUE DE CONFIDENTIALITE ET DE GESTION DES COOKIES DE LIMITLESS EVOLUTION</h1>
    
    <div class="bloc-text" id="no-scroll">
        <p> Cette politique de confidentialité décrit les données personnelles qui sont collectées ou générées (traitées) lorsque vous  interagissez avec Limitless Evolution par l’intermédiaire de nos sites internet , expériences digitales, applications mobiles, magasins, évènements, ou l’un de nos autres produits ou services, lesquels font tous partie de la Plateforme Limitless Evolution (“Plateforme”). Elle explique également la façon dont vos données personnelles sont utilisées, partagées et protégées, les choix dont vous disposez s’agissant de vos données personnelles et la façon dont vous pouvez nous contacter.
        </p>

        <p>Qui est responsable du traitement de vos données personnelles ?</p>

        <p>L’entité Limitless Evolution responsable du traitement de vos données personnelles va dépendre de la façon dont vous interagissez avec la Plateforme de Limitless Evolution et de votre localisation géographique dans le monde. Les entités Limitless Evolution pertinentes sont désignées par “Limitless Evolution”, “notre”/“nos” et “nous” dans la présente Politique de Confidentialité.
        </p>

        <p> Merci de consulter notre Liste des Entités Locales pour le nom de l’entité Limitless Evolution responsable et ses coordonnées.</p>

        <p> Quelles sont les données personnelles que nous collectons et à quel moment ?</p>
        ...
        <p>
            ...
            informations relatives aux réseaux sociaux, comprenant les identifiants et toute information résultant de vos posts publics au sujet de Limitless Evolution ou vos communications avec nous.
            ...
            Dans de nombreux cas, l’utilisation de certaines fonctionnalités de notre Plateforme nécessitent de fournir à Limitless Evolution des données complémentaires ou un consentement additionnel, et ce pour l’utilisation de vos données à certaines fins. Par exemple, pour utiliser le suivi de fréquence cardiaque disponible sur notre Plateforme, il peut être nécessaire de vous connecter à un outil de suivi de fréquence cardiaque. De la même manière, pour partager du contenu sur les réseaux sociaux, vous pouvez être invités à fournir vos identifiants de compte sur le réseau social pour vous inscrire.

            Pour fournir des informations sur nos produits, services, évènements et à d’autres fins promotionnelles

            Si vous y consentez, nous vous enverrons des communications marketing et des nouvelles à propos des produits, services, évènements et autres promotions de Limitless Evolution susceptibles de vous intéresser.  Vous pouvez vous désinscrire à tout moment après avoir donné votre consentement.

            Marketing direct

            Si vous êtes actuellement un client de Limitless Evolution (par exemple, si vous avez effectué une commande auprès de nous), nous pouvons utiliser les informations de contact que vous avez fournies pour vous envoyer des communications marketing à propos de produits ou services Limitless Evolution similaires, lorsque la loi applicable le permet (à moins que vous les ayez refusées). Dans d’autres cas, nous vous demandons votre consentement pour vous envoyer des communications marketing.

            Personnalisation

            Nous pouvons utiliser les informations que vous nous fournissez, ainsi que les informations provenant d’autres produits ou services Limitless Evolution – telles que votre utilisation de la Plateforme Limitless Evolution, vos visites ou achats effectués dans les magasins Limitless Evolution, votre participation aux évènements et compétitions Limitless Evolution –, pour vous envoyer des communications personnalisées sur des produits et services susceptibles de vous intéresser. Ce faisant, nous pouvons combiner les informations que vous nous fournissez avec des informations que nous générons sur la base de votre activité en ligne, y compris les observations et analyses internes.
        </p>

        <p>Pour faire fonctionner, améliorer et maintenir nos activités, produits et services
            ...
            Pour protéger nos droits, nos biens, ceux des autres, et assurer notre sécurité et celle des autres
            ...
            Nous utilisons les données relatives à la façon dont nos visiteurs utilisent notre Plateforme et nos services, pour comprendre les comportements et préférences des consommateurs.  Par exemple, nous pouvons utiliser les informations sur la façon dont les visiteurs de Limitless Evolution.com cherchent et trouvent les produits sur ce site afin de comprendre la meilleure façon d’organiser et de présenter nos produits dans les vitrines de nos magasins.

            Utilisation (traitement) des informations d’entraînement

            Comme indiqué ci-dessus, Limitless Evolution collecte des données sur votre activité physique ou sur vos caractéristiques physiques (les “Informations d’Entraînement”) pour vous fournir des services sur notre Plateforme.  Compte tenu du caractère personnel de ces données, nous nous efforçons de vous fournir des informations claires sur la manière dont celles-ci seront utilisées.  Dans la mesure où ces données peuvent être considérées comme sensibles dans certains pays, nous prenons les mesures nécessaires pour leur protection et leur utilisation et, si cela est requis par la législation applicable ou par les politiques internes de Limitless Evolution, nous sollicterons votre consentement pour leur utilisation. Cliquez ici pour en savoir plus.
            ...
            Lorsque vous achetez des produits Limitless Evolution à partir de notres Plateforme, nous avons besoin de vos données personnelles pour exécuter le contrat qui nous lie à vous. Par exemple, nous avons besoin de vos informations de contact et de paiement pour vous livrer votre commande.
        ...
        <p>
            ...
            Utiliser la Plateforme Limitless Evolution avec des produits et services tiers 
            ...
            Si vous décidez de connecter votre compte Limitless Evolution avec des modules ou comptes tiers, vos droits et données personnelles seront régis par les conditions de ces plateformes tierces. Par exemple, si vous décidez de partager votre activité Limitless Evolution sur un réseau social, les conditions de ce réseau social s’appliqueront aux données personnelles concernées. 

            Notre Plateforme peut proposer des liens vers d’autres sites internet et applis (de tiers) pour répondre à vos besoins ou vous fournir des informations. Ces sites et applis tiers ont leur propre politique de protection des données, que nous vous invitons à lire. Dans la mesure où Limitless Evolution ne détient ni ne contrôle ces sites ou applis tiers, nous ne pouvons être tenus responsables de leurs contenus, de leur utilisation ou de leurs pratiques en matière de données personnelles. 
            ...
            Si vous souhaitez nous faire part de vos commentaires ou si vous avez des questions ou des préoccupations, ou si vous souhaitez exercer vos droits en lien avec vos données personnelles, il suffit de vous connecter à notre plateforme Limitless Evolution Privacy Webform.

            Les coordonnées de notre Délégué à la Protection des Données sont les suivantes : Bureau de la Protection des Données Personnelles, Limitless Evolution Retail B.V., Colosseum 1, 1213NL, Pays-Bas ou privacy@Limitless Evolution.com.
